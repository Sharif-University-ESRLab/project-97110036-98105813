...
const char* lamp_status_request_address = "http://myproject-magiclamp.fandogh.cloud/control/getupdate/";
const char* schedule_request_address = "http://myproject-magiclamp.fandogh.cloud/control/getschedule/";
const char* post_lamp_status_address = "http://myproject-magiclamp.fandogh.cloud/control/report/";

/*** WiFi config ***/
const char* ssid = "soli";
const char* password = "sol19375";
